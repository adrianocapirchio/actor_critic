# -*- coding: utf-8 -*-
"""
Created on Tue Oct 03 15:37:57 2017
...
if __name__ == "__main__":
   ...
   # reward_position = np.array([rdm.uniform(0,1),rdm.uniform(0,1)])
    reward_position = np.array([0.5,0.5])         
    ...
    for trial in xrange(bg.n_trial):
        ...
        for movement in xrange(bg.max_trial_movements):
            ...
            bg.actual_state = np.reshape(utils.gaussian(wrist.actual_3dposition, bg.X, bg.std_dev), (30))
